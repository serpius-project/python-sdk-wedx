...
load_dotenv()
USER_ADDRESS = os.getenv('USER_ADDRESS_1')
USER_PRIVATE_KEY = os.getenv('USER_PRIVATE_KEY_1')
...
# Initialize the SDK
CHAIN_ID = 42161  # 8453 for Base mainnet, 42161 for Arbitrum
...
def main():
    ...
    new_assets, new_distribution = create_tvlw_portfolio()
